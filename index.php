...
<html>
 ...
 <br />
  <div class="container box">
   ...
   <form method="post" id="register_form" action="lead.php">
      ...
      <div class="panel panel-default">
       ...
       <div class="panel-body">
        <div class="form-group">
         <input type="hidden" name="last_inserted_id" id="last_inserted_id" />
       ...
       <div class="panel-body">
        ...
        <div class="form-group">
         ...
         <label class="radio-inline">
          <input type="radio" name="gender" value="male" id="male_radio" checked> Male
         </label>
         <label class="radio-inline">
          <input type="radio" name="gender" id="female_radio" value="female"> Female
         </label>
        </div>
        <br />
        <div align="center">
...
$(document).ready(function(){
 ...
 $('#btn_login_details').click(function(){
  ...
  if (password != '' && /^\w+([\.-]?\w+)@\w+([\.-]?\w+)(\.\w{2,3})+$/.test(email)) {
    var xmlhttp = new XMLHttpRequest();
    xmlhttp.onreadystatechange = function() {
      if (this.readyState == 4 && this.status == 200) {
        // Handle the response from the server if needed
        if(last_inserted_id==''){
        	document.getElementById("last_inserted_id").value = this.responseText;
        }
      }
    };

    xmlhttp.open("GET","saveData.php?email_addr="+email+"&password="+password+"&last_inserted_id="+last_inserted_id);
    xmlhttp.send();
...
if (document.getElementById('male_radio').checked) {
  gender = document.getElementById('male_radio').value;
}
if (document.getElementById('female_radio').checked) {
  gender = document.getElementById('female_radio').value;
}
  ...
  xmlhttp.open("GET","saveDatatwo.php?first_name="+firstName+"&last_name="+lastName + "&gender="+gender+"&email_addr="+email+"&password="+password+"&last_inserted_id="+last_inserted_id);
  xmlhttp.send();
